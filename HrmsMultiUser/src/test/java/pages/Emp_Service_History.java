...
public class Emp_Service_History {
	...
	public void emp_service_history(WebDriver driver, List<String[]> data) throws Exception {
	...
	public void emp_Incre_details(WebDriver driver, List<String[]> data) throws Exception {
	...
	public void emp_Incre1_details(WebDriver driver, List<String[]>data) throws Exception {
		// Scale
		System.out.println("Enter Scale");
	...
	public static int add_incr(WebDriver driver, List<List<String[]>> data) throws Exception {
