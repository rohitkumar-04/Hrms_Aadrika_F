...
public class DM_ConnectForCollibra_Locators
{
    @FindBy(how = How.XPATH,using = "//a[@href='/MartPortal/main/settings']")
    public WebElement Settings_Page;

    @FindBy(how = How.XPATH,using = "//button[text()='Collibra Configurations']")
    public WebElement CollibraConfigTab;

    @FindBy(how = How.XPATH,using = "//button[text()='Add']")
    public WebElement AddConfigDetailsButton;


    @FindBy(how = How.XPATH,using = "//input[@placeholder='Enter Mart Connector License']")
    public WebElement MartConnectorTextBox;
    ...
    @FindBy(how = How.XPATH,using = "//input[@placeholder='Enable SSL']")
    public WebElement EnableSSLTextBox;
    ...
    @FindBy(how = How.XPATH,using = "//a[@href='/MartPortal/main/collibra']")
    public WebElement DMConnect_ForCollibra;
    ...
    @FindBy(how = How.XPATH,using = "//input[@id='communities']")
    public WebElement CommunityInput;

    @FindBy(how = How.XPATH,using = "//input[@id='pdds']")
    public WebElement PDDNameInput;
    @FindBy(how = How.XPATH,using = "//input[@id='ldds']")
    public WebElement LDDNameInput;
